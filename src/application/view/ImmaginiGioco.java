...
public class ImmaginiGioco {
    ...
    public ImmaginiGioco() throws IOException {
        ...
        backgroundImage2 = ImageIO.read(new File("src/application/resources/background/sfondo_liv2.png"));
        backgroundImage2 = backgroundImage2.getScaledInstance(1830,Settings.WINDOW_SIZE_Y,Image.SCALE_SMOOTH);
        backgroundImage3 = ImageIO.read(new File("src/application/resources/background/sfondo_liv3.jpg"));
        backgroundImage3 = backgroundImage3.getScaledInstance(3120,Settings.WINDOW_SIZE_Y,Image.SCALE_SMOOTH);
        personaggioDes= ImageIO.read(new File("src/application/resources/personaggio/steve.png"));
        ...
        start_screen = ImageIO.read(new File("src/application/resources/background/main_screen_image.png"));
        ...
        alex_completo = ImageIO.read(new File("src/application/resources/background/alex_completo.png"));
        alex_completo = alex_completo.getScaledInstance(Settings.CELL_SIZE_RIGA*5,Settings.CELL_SIZE_COLONNA*10,Image.SCALE_SMOOTH);
        pausa = ImageIO.read(new File("src/application/resources/background/pausa.png"));
        ...
        scudoDX = ImageIO.read(new File("src/application/resources/personaggio/steveScudo.png"));
